...
// DeleteToken provides a mock function with given fields: ctx, request
func (_m *Token) DeleteToken(ctx context.Context, request *dto.ResetPasswordRequest) (*entity.PasswordTokens, error) {
	ret := _m.Called(ctx, request)
...
// FindToken provides a mock function with given fields: ctx, request
func (_m *Token) FindToken(ctx context.Context, request *dto.ResetPasswordRequest) ([]entity.PasswordTokens, error) {
	ret := _m.Called(ctx, request)
